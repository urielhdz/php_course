<?php
	...
	$nombres = $c->execute_query("SELECT n.nombre as nombre,e.nombre as nombreEstado,n.id as id,m.nombre as nombreCiudad FROM nombres as n LEFT JOIN estados as e ON n.idEstado = e.id LEFT JOIN municipios as m ON m.id = n.idMunicipio");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	?>
			<tr>
				...
				<td><?php echo $nombre["nombreCiudad"]  ?></td>
				<td> 
